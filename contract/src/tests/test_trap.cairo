mod tests {
    ...
    fn test_different_trap_types_behavior() {
        ...
        let mut explosive_trap = create_trap(
            10, owner, 0_u32, 0_u32, 3_u32, 80_u16, TrapType::Explosive,
        );
        let mut poison_trap = create_trap(
            11, owner, 10_u32, 10_u32, 4_u32, 20_u16, TrapType::Poison,
        );
        let mut electric_trap = create_trap(
            12, owner, 20_u32, 20_u32, 2_u32, 45_u16, TrapType::Electric,
        );
        let mut freezing_trap = create_trap(
            13, owner, 30_u32, 30_u32, 5_u32, 15_u16, TrapType::Freezing,
        );
    ...
    fn test_trap_edge_cases() {
        ...
        let zero_radius_trap = create_trap(
            7, owner, 10_u32, 10_u32, 0_u32, 50_u16, TrapType::Explosive,
        );
        ...
        let large_radius_trap = create_trap(
            8, owner, 0_u32, 0_u32, 100_u32, 10_u16, TrapType::Poison,
        );
