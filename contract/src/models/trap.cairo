...
mod tests {
    ...
    fn test_different_trap_types() {
        ...
        let explosive_trap = create_trap(1, owner, 0_u32, 0_u32, 3_u32, 80_u16, TrapType::Explosive);
        let poison_trap = create_trap(2, owner, 10_u32, 10_u32, 2_u32, 20_u16, TrapType::Poison);
        let electric_trap = create_trap(3, owner, 20_u32, 20_u32, 4_u32, 45_u16, TrapType::Electric);
        let freezing_trap = create_trap(4, owner, 30_u32, 30_u32, 1_u32, 15_u16, TrapType::Freezing);
